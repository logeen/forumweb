...
<!-- BEGIN searchresults -->
<tr> 
<td class="row1" ><div ><img src="{searchresults.TOPIC_FOLDER_IMG}"   alt="{searchresults.L_TOPIC_FOLDER_ALT}" title="{searchresults.L_TOPIC_FOLDER_ALT}" />{searchresults.MY_TOPIC_IMG}</div></td>
