...
<tr>
<th class="thtop" ="" >&nbsp;#&nbsp;</th>
<th class="thcornerl" ="" >&nbsp;{L_WWW}&nbsp;</th>
<th class="thtop" ="" >&nbsp;{L_PREZENTACJA}&nbsp;</th>
<th class="thtop" ="" >&nbsp;{L_TRESC}&nbsp;</th>
<th class="thtop" ="" >&nbsp;{L_OCENA}&nbsp;</th>
<!-- BEGIN switch_recenzent_wyniki_oficjalne -->
<th class="thtop" ="" >{L_RECENZJE}</th>
<!-- END switch_recenzent_wyniki_oficjalne -->
<!-- BEGIN switch_recenzent -->
<th class="thtop" ="" >&nbsp;{L_KOMENTARZE}&nbsp;</th>
<!-- BEGIN switch_recenzent_level -->
<th class="thtop" ="" >&nbsp;{L_PUNKTY}&nbsp;</th>
<!-- BEGIN switch_wyniki -->
<th class="thtop" ="" >&nbsp;{L_DZIALANIE}&nbsp;</th>
<!-- END switch_wyniki -->
<!-- END switch_recenzent_level -->
<!-- BEGIN switch_wyniki_nieoficjalne -->
<th class="thtop" ="" >&nbsp;{L_OCEN}&nbsp;</th>
<!-- END switch_wuniki_nieoficjalne -->
<!-- BEGIN switch_wyniki -->
<th class="thtop" ="" >&nbsp;{L_OCENY}&nbsp;</th>
<!-- END switch_wyniki -->
<!-- END switch_recenzent -->
</tr>
<!-- BEGIN wynikirow -->
<tr onclick="high(this)" onmouseover="highlight(this)" onmouseout="unhighlight(this)">
<td class="row2 {wynikirow.ROW_CLASS}" ><span class="gen">&nbsp;{wynikirow.NUMBER}&nbsp;</span></td>
<td class="row1 {wynikirow.ROW_CLASS}"><span class="gen">&nbsp;<a href="http://{wynikirow.URL}" onmouseover="this.nextSibling.getElementsByTagName('span')[0].style.display = 'inline'" onmouseout="this.nextSibling.getElementsByTagName('span')[0].style.display = 'none'">{wynikirow.URL}</a><span class="konkurs_wyniki"><span >
<script type="text/javascript"><!--
wsr_snapshot('http://{wynikirow.URL}', 'D4Bto6v2348K', 's');
//--></script>
</span></span>&nbsp;</span>
<!-- BEGIN switch_edycje -->
<b><a href="javascript:void(0)" title="{wynikirow.switch_edycje.COUNT}" onclick="with (document.getElementById('www{wynikirow.ID}').style) { if (display == 'none') { display = 'block'; this.innerHTML = '&laquo;'} else { display = 'none'; this.innerHTML = '&raquo;' } } return false">&raquo;</a></b>&nbsp;<div id="www{wynikirow.ID}" class="gensmall" >
<!-- BEGIN monthrow -->
...
<td class="row2 {wynikirow.ROW_CLASS}" ><span class="genmed">{wynikirow.OCENA_PREZENTACJA}</span></td>
<td class="row2 {wynikirow.ROW_CLASS}" ><span class="genmed">{wynikirow.OCENA_TRESC}</span></td>
<td class="row2 {wynikirow.ROW_CLASS}" ><span class="genmed"><b>{wynikirow.OCENA}</b></span></td>
<!-- BEGIN switch_recenzent_wyniki_oficjalne -->
