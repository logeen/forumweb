...
<!-- BEGIN searchresults -->
<tr> 
<td class="cathead" colspan="2" ><span class="topictitle">&nbsp;{L_TOPIC}:&nbsp;<a href="{searchresults.U_TOPIC}">{searchresults.TOPIC_TITLE}</a></span></td>
</tr>
<tr> 
<td  v class="row1" rowspan="2"><span class="name"><b>{searchresults.POSTER_NAME}</b></span><br />
<br />
