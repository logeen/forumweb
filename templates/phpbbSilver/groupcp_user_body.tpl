...
<th colspan="2"  class="thhead" >{L_GROUP_MEMBERSHIP_DETAILS}</th>
  </tr>
...
<table    >
<tr>
<td  class="gensmall">{GROUP_MEMBER_SELECT}</td>
<td  > 
...
<table    >
<tr>
<td  class="gensmall">{GROUP_PENDING_SELECT}</td>
<td  > 
<input type="submit" value="{L_VIEW_INFORMATION}" class="liteoption" />
{S_HIDDEN_FIELDS} </td>
</tr>
...
<th colspan="2"  class="thhead" >{L_JOIN_A_GROUP}</th>
  </tr>
  <tr> 
...
<table    >
<tr>
<td  class="gensmall">{GROUP_LIST_SELECT}</td>
<td  > 
<input type="submit" value="{L_VIEW_INFORMATION}" class="liteoption" />
{S_HIDDEN_FIELDS} </td>
</tr>
