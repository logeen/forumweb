...
<td class="row2" width="80%"><span class="gen">{GROUP_NAME}</span></td>
</tr>
<tr> 
...
<label for="label__group_type__{S_GROUP_OPEN_TYPE}">{L_GROUP_OPEN}</label> &nbsp;&nbsp; 
...
<label for="label__group_type__{S_GROUP_CLOSED_TYPE}">{L_GROUP_CLOSED}</label> &nbsp;&nbsp; 
...
<label for="label__group_type__{S_GROUP_HIDDEN_TYPE}">{L_GROUP_HIDDEN}</label> &nbsp;&nbsp; 
...
<td class="catsides" colspan="9" height="28"><span class="cattitle">{L_GROUP_MODERATOR}</span></td>
	</tr>
	<tr> 
...
<td class="row1" align="center">{MOD_HELPS}</td>
...
<td class="{member_row.ROW_CLASS}" align="center">{member_row.HELPS}</td>
...
<td class="catbottom" colspan="9" align="right" height="28"> 
