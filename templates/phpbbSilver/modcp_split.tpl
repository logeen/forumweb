<div class="modcp_split-tpl">	
	<form method="post" action="{S_SPLIT_ACTION}">    		
		...
		<table class="forumline">			
			<tr>   				
				<th class="thhead" colspan="3">{L_SPLIT_TOPIC} 				
				</th>			
			</tr>			
			<tr>   				
				<td class="row1" colspan="3">					
					<span class="genmed">{L_SPLIT_TOPIC_EXPLAIN} 					
					</span></td>			
			</tr>			
			<tr>   				
				...
				<td class="row2" colspan="2">					
					...
					<a href="posting.php?mode=topicreview&amp;t=169" onclick="document.getElementById('iframe_regulations').style.display = document.getElementById('iframe_regulations').style.display == 'none' ? 'block' : 'none'; return false"><b>{L_REGULATIONS}...</b></a>  					
					<iframe  id="iframe_regulations" src="posting.php?mode=topicreview&amp;t=169">					
					</iframe></td>			
			</tr>			
			<tr>   				
			...
			<tr>   				
				<td class="cathead" colspan="3">   					
					...
					<input class="liteoption" type="submit" name="split_type_beyond" value="{L_SPLIT_AFTER}" /></td>			
			</tr>			
			<tr>   				
				<th class="thleft">{L_AUTHOR} 				
				</th>				
				<th>{L_MESSAGE} 				
				</th>				
			...
			<tr>   				
				<td class="{postrow.ROW_CLASS}">					
					<span class="name">						
						<a name="{postrow.U_POST_ID}"></a>{postrow.POSTER_NAME} 					
					</span></td>				
				<td class="{postrow.ROW_CLASS}">   					
					<table>						
						<tr>   							
			...
			<tr>   				
				<td class="catBottom" colspan="3">   					
					<input class="liteoption" type="submit" name="split_type_all" value="{L_SPLIT_POSTS}" />&nbsp;&nbsp;&nbsp;&nbsp;   					
					<input class="liteoption" type="submit" name="split_type_beyond" value="{L_SPLIT_AFTER}" />{S_HIDDEN_FIELDS} </td>			
			</tr>		
		</table>		
		<table>			
			<tr>   				
