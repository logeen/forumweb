...
<td ><a href="{userrow.U_SEARCHPOSTS}" title="{userrow.L_SEARCH_POSTS}"><img src="{SEARCH_IMG}"  alt="{L_SEARCH}"   /></a> 
&nbsp;</td>
</tr>
</table>
</td>
...
<tr>
<td  class="row3"><label for="label__host_id">{L_HOST}:</label></td>
...
//--></script>
<textarea name="description" cols="50" rows="5"  onfocus="maxlength(this, 255)">{USERNAME}</textarea>
</td>
</tr>
<tr>
<td colspan="2"  class="catbottom"><input type="submit" value="{L_SUBMIT}" class="mainoption" /></td>
</tr>
</table>
</form>
<!-- END switch_admin -->
