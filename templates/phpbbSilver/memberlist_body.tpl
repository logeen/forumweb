...
<td class="{memberrow.ROW_CLASS}" ><a href="{memberrow.U_VIEWPROFILE}">{memberrow.USERNAME}</a></td>
...
<!-- BEGIN switch_admin_option -->
<td class="{memberrow.ROW_CLASS}" ><input type="checkbox" name="id[]" value="{memberrow.USER_ID}" /></td>
<!-- END switch_admin_option -->
</tr>
<!-- END memberrow -->
<!-- BEGIN switch_admin_option -->
