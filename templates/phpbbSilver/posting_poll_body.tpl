            ...
            <tr>
				<td class="row1"><span class="gen"><b>{L_TYPE}</b></span></td>
				<td class="row2"><span class="genmed">{S_POLL_TYPE_TOGGLE}</td>
			</tr>
			<!-- END switch_poll_type_toggle -->
			<!-- BEGIN switch_poll_delete_toggle -->
            <tr>
				<td class="row1"><span class="gen"><b><label for="label__poll_delete">{L_POLL_DELETE}</label></b></span></td>
				<td class="row2"><input type="checkbox" id="label__poll_delete" name="poll_delete" /></td>
			</tr>
